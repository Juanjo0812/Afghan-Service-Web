...
export default function ContactPage() {
  ...
  return (
    <>
      {/* Page Header */}
      <section className="section-padding bg-warm-sand/30" aria-label="Contact header">
        <div className="container-main pt-10">
          <span className="label-text block mb-3">CONTACT US</span>
          <h1 className="font-display text-3xl md:text-4xl lg:text-display-l text-forest max-w-2xl mb-4">
            We're Here to Help
          </h1>
          <p className="text-body-lg text-forest-light max-w-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-card border border-warm-sand/50">
                ...
                {/* Map Placeholder */}
                <div className="mt-8 aspect-video bg-warm-sand/50 rounded-xl flex items-center justify-center border border-warm-sand/50">
                  <div className="text-center">
                    <MapPin className="w-8 h-8 text-forest-light/50 mx-auto mb-2" aria-hidden="true" />
                    <p className="text-body-sm text-forest-light">
                      Map &mdash; 5151 N 19th Ave, Phoenix, AZ
                    </p>
                  </div>
                </div>
              </div>
