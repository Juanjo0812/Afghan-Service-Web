      ...
      >
        <div className="container-main">
          <div className="flex items-center justify-between h-16 md:h-[72px]">
            ...
            >
              <img src="/images/Catholic.png" alt="Catholic Charities Logo" className="h-10 md:h-12 w-auto" />
            </Link>

            {/* Desktop Navigation */}
            <nav className="hidden lg:flex flex-1 justify-center items-center gap-4 xl:gap-6 mx-4" aria-label="Main navigation">
              {navItems.map((item) => {
